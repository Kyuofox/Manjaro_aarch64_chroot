...
_tabversion   = '3.10'
_lextokens    = set(('INT_CONST_OCT', '__INT128', 'SIGNED', 'LONG', 'EQUALS', 'OREQUAL', 'CHAR', 'LBRACE', '_BOOL', 'PLUSEQUAL', 'OFFSETOF', 'INT_CONST_CHAR', 'RESTRICT', 'FLOAT_CONST', 'LE', 'GE', 'FOR', 'WHILE', 'INT_CONST_BIN', 'MINUSMINUS', 'VOID', 'RSHIFT', 'RBRACKET', 'ELLIPSIS', 'RETURN', 'ID', 'DEFAULT', 'STRING_LITERAL', 'LPAREN', 'LBRACKET', 'DO', 'LNOT', 'XOR', 'SIZEOF', '_COMPLEX', 'ENUM', 'AND', 'ANDEQUAL', 'COMMA', 'NOT', 'UNION', 'ELSE', 'VOLATILE', 'EXTERN', 'TIMESEQUAL', 'TYPEID', 'STRUCT', 'PLUS', 'LSHIFTEQUAL', 'CHAR_CONST', 'RPAREN', 'OR', 'LAND', 'MINUS', 'TIMES', 'ARROW', 'REGISTER', 'MOD', 'DIVEQUAL', 'PERIOD', 'LT', 'DOUBLE', 'CONTINUE', 'INT_CONST_DEC', 'INT_CONST_HEX', 'PLUSPLUS', 'DIVIDE', 'NE', 'STATIC', 'PPPRAGMASTR', 'HEX_FLOAT_CONST', 'CONST', 'SHORT', 'BREAK', 'RSHIFTEQUAL', 'WSTRING_LITERAL', 'XOREQUAL', 'GT', 'COLON', 'WCHAR_CONST', 'PPHASH', 'AUTO', 'RBRACE', 'TYPEDEF', 'EQ', 'LOR', 'CASE', 'INLINE', 'GOTO', 'CONDOP', 'LSHIFT', 'PPPRAGMA', 'FLOAT', 'MODEQUAL', 'SEMI', 'IF', 'SWITCH', 'MINUSEQUAL', 'INT', 'UNSIGNED'))
_lexreflags   = 64
_lexliterals  = ''
